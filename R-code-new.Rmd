...
```{r, echo=F, eval = F}
load("internal/glmm.RData")
## power analysis
power_simul <- simr::powerSim(fit = models$m2, progress = F)
save(power_simul, file = "internal/glmm_m2_power.RData")



model2 <‐ simr::extend(models$m2, along = "x", n = 200)
